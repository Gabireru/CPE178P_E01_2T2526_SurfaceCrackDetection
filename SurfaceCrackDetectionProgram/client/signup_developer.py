...
def main(page: ft.Page):
    page.title = "Crack Detection System - Developer Signup"
    ...
    # Developer account link not needed here, can just stay as print or remove
    dev_link = ft.Button(
        content=ft.Text(
            "CLICK ME FOR ENGINEER",
        ...
        content=ft.Stack(
            controls=[
                    ft.IconButton(
                        ...
                        top=20,
                        left=20,
                        on_click=lambda e: page.go("/")  # go to landing page instead of pop
                    ),
                ...
                ft.Container(content=dev_link, left=100, top=730)
            ]
        )
    )
