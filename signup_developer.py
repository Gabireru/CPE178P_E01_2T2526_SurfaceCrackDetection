...
def main(page: ft.Page):
    ...
    # UPDATED: Changed from ElevatedButton to the modern Button
    ...
    # UPDATED: Changed from TextButton to the modern Button
    dev_link = ft.Button(
        content=ft.Text(
            "CLICK ME FOR DEVELOPER ACCOUNT", 
...
if __name__ == "__main__":
    # UPDATED: Swapped back to ft.run to avoid the deprecation warning
